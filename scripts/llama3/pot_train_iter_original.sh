...
mode="pot"
# output config
exp_name="${mode}_wo_smooth_sample_${sample_num}_correct_${min_correct_num}_orig_${include_original_data}_preiter_${include_pre_iter_data}"
...
do
        ...
        cur_sampled_data_file="${iter_output_dir}/inference_data/results_before_resample.json"
