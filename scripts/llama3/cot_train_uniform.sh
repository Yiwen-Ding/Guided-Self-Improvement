...
# output config
exp_name="uniform_sample_${sample_num}_correct_${min_correct_num}_max_${max_resample_num}_orig_${include_original_data}_preiter_${include_pre_iter_data}"
