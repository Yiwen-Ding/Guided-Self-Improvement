...
inference_data_files=("./data/inference/pot/aqua_rat.json" "./data/inference/pot/gsm8k.json" "./data/inference/pot/math.json")
...
# output config
exp_name="${mode}_rationale_driven_sample_${sample_num}_correct_${min_correct_num}_max_${max_resample_num}_orig_${include_original_data}_preiter_${include_pre_iter_data}"
...
cp "./data/MathInstruct_pot.json" "${exp_output_dir}/iter_data/${dataset_name}_iter_0.json"

# original iter train data
mkdir -p "${exp_output_dir}/iter_data_original/"
cp "./data/MathInstruct_pot.json" "${exp_output_dir}/iter_data_original/${dataset_name}_iter_0.json"
...
do
        ...
        for i in "${!datasets[@]}"; do
                ...
                python_script="inference_rationale_driven.py" \
